...
if (!process.env.NEON_DATABASE_URL) {
  ...
  console.log('Usage:');
  console.log('  export NEON_DATABASE_URL="your-neon-connection-string"');
  console.log('  node apply_neon_trigger_fix.js\n');
  process.exit(1);
}

// Create pool with Neon connection string
const pool = new Pool({
...
async function applyFix() {
  ...
  try {
    ...
    console.log('📝 Applying distributor outstanding trigger fix...\n');
    ...
    console.log('\n✅ Neon production database fix applied successfully!\n');
